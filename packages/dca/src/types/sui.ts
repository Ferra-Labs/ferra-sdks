...
export type WithTx<T> = T & {
  tx?: Transaction
}

/**
 * Constants for different modules in the DCA (Cryptocurrency Liquidity Mining Module).
 */
export const DcaPartnerModule = 'partner'
export const DcaIntegratePoolModule = 'pool_script'
export const DcaIntegrateRouterModule = 'router'
export const DcaIntegrateRouterWithPartnerModule = 'router_with_partner'
export const DcaFetcherModule = 'fetcher_script'
export const DcaExpectSwapModule = 'expect_swap'
export const DcaIntegrateUtilsModule = 'utils'
