...
describe('add Liquidity Module', () => {
  ...
  test('add liquidity for input liquidity', async () => {
    ...
    const coinAmounts = DammPoolUtil.getCoinAmountFromLiquidity(new BN(liquidity), curSqrtPrice, lowerSqrtPrice, upperSqrtPrice, false)
  ...
  test('add liquidity for input totalAmount', async () => {
    ...
    const liquidity = DammPoolUtil.estimateLiquidityFromcoinAmounts(curSqrtPrice, tick_lower_index, tick_upper_index, tokenAmounts)
