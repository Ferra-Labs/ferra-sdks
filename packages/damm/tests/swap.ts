...
const TICKS = [
  {
    ...
    rewarders_growth_outside: [225471669413192400],
  },
  {
    index: -37940,
    ...
    fee_growth_outside_a: '21235955800934414',
    fee_growth_outside_b: '424794219427463',
    rewarders_growth_outside: [225489888127862050],
  },
  {
    index: -37740,
    ...
    fee_growth_outside_a: '21235955800934414',
    fee_growth_outside_b: '424794219427463',
    rewarders_growth_outside: [225425239826209820],
  },
  {
    index: -37100,
  ...
  },
  {
    ...
    rewarders_growth_outside: [41621905147691010],
  },
  {
    index: -36240,
...
async function main() {
  ...
  const pool = await sdk.Pool.getPool('0x4452d10391154b8694982734a19ea1d9d22412099f6735e1d6d1af7d8f719905')
  ...
  if (swapResults) {
    const swapOnChain = await sdk.Swap.preswap({
      byAmountIn: true,
      a2b: false,
      amount: "1000000",
      pool: pool!,
      ...
      coinTypeA: pool.coinTypeA,
      coinTypeB: pool.coinTypeB,
      currentSqrtPrice: Number(pool.currentSqrtPrice)
    })
    ...
    console.log('swapOnChain', swapOnChain)
    return
  }
