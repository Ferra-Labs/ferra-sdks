...
import { ClmmConfig, CoinAsset, Package, SuiResource, SuiAddressType, TokenConfig } from './types'
...
/**
 * The entry class of FerraClmmSDK, which is almost responsible for all interactions with CLMM.
 */
export class FerraClmmSDK {
