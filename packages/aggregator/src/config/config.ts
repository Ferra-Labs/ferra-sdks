import FerraAggregatorSDK from '../main'
...
export function initFerraSDK(options: InitFerraSDKOptions): FerraAggregatorSDK {
...
export function initFerraAggregatorSDK(options: InitFerraSDKOptions): FerraAggregatorSDK {
