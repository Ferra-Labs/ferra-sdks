 ...
 */
export const DlmmFactoryModule = 'lb_factory'
export const DlmmPairModule = 'lb_pair'
export const DlmmQuoterModule = 'lb_quoter'
export const DlmmRouterModule = 'lb_router'
export const DlmmTokenModule = 'lb_token'
...
export const getDefaultSuiInputType = (value: any): SuiInputTypes => {
  ...
  throw new DlmmPairsError(`Unknown type for value: ${value}`, TypesErrorCode.InvalidType)
}
